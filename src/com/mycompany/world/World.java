...
import com.mycompany.entities.Fruta;
import com.mycompany.entities.Player;
import com.mycompany.entities.Whey;
...
public class World {
			...
			for(int xx = 0; xx < map.getWidth(); xx++){
				for(int yy = 0; yy < map.getHeight(); yy++){
					...
					if(pixelAtual == 0xFF000000){
						...
						Whey whey = new Whey(xx*16,yy*16,16,16,0,Entity.whey);
						Game.entities.add(whey);
						Game.whey_cont++;
					}
	...
	public static void restartGame(){
		Game.player = new Player(0,0,16,16,1,Game.spritesheet.getSprite(96, 0, 16, 16));
		Game.entities.clear();
